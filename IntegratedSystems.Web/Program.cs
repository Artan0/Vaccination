...
builder.Services.AddScoped(typeof(IVaccinationCenterService), typeof(VaccinationCenterService));
builder.Services.AddScoped(typeof(IPatientService), typeof(PatientService));
builder.Services.AddScoped(typeof(IVaccineService), typeof(VaccineService));
